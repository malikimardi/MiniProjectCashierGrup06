              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    ...
                    transaksi Anda sehingga Anda bisa menjual lebih banyak lagi.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600 text-sm">
                      ...
                      akurat untuk bisnis kuliner, mulai dari dine-in, pick-up,
                      hingga delivery
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                  ...
                  berbagai kanal, pengelolaannya bisa lewat satu aplikasi Moka.
                  Simpel dan praktis!
                </p>
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  ...
                  <p className="mt-4 text-lg leading-relaxed text-gray-600">
                    desain yang sangat simpel membuat siapapun langsung mengerti
